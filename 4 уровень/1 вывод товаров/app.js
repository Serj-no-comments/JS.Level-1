...
const productsB=document.querySelector('.products');
...
function showCategory(category) {
    const categoryP = products[category];
    let markupToProductsDiv = '';
    categoryP.forEach(function (product) {
        markupToProductsDiv += getProductMarkup(product);
    });
    productsB.insertAdjacentHTML("afterbegin", markupToProductsDiv);
}
